...
async def gen_thumb(videoid):
    ...
    try:
        ...
        return f"https://telegra.ph/file/37bd892673e01954d833c.jpg"
...
async def play(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𖤐↜𝑪𝑯 𝑺𝑶𝑼𝑹𝑪𝑬↝𖤐", url=f"https://t.me/M_T_lI")],
    ...
    if message.reply_to_message:
        ...
        for data in (await search.next())["result"]: 
            try:
                ...
                return await dream.edit_text(f"◍ حدث خطأ ما\n`{e}`\nفى حاله ظهور لك مثلا هذه الرساله تواصل مع المطور -> @{SA_FEV}")
    ...
    if admin(msg):
        ...
        if command == "/pause":
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton("𖤐↜𝑪𝑯 𝑺𝑶𝑼𝑹𝑪𝑬↝𖤐", url="https://t.me/M_T_lI")],
